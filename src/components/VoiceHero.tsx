  ...
  return (
    <div className="mb-8 sm:mb-10 flex justify-center">
      ...
      >
        <span
          className={
            "voice-breathing-glow absolute inline-flex h-28 w-28 sm:h-32 sm:w-32 rounded-full blur-xl " +
            (isRecording ? "bg-destructive/40" : "bg-primary/25")
          }
        />
        <span
          className={
            "voice-breathing-ring absolute inline-flex h-24 w-24 sm:h-28 sm:w-28 rounded-full border " +
            (isRecording ? "border-destructive/50" : "border-primary/30")
          }
        />
        {isRecording && (
          <span className="absolute inline-flex h-24 w-24 sm:h-28 sm:w-28 rounded-full bg-destructive/30 animate-ping" />
        )}
        <div
          className={
            "voice-breathing-core relative flex h-20 w-20 sm:h-24 sm:w-24 items-center justify-center rounded-full shadow-lg " +
            (isRecording
